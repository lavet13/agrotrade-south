  ...
  return (
    <footer className="w-full py-6 border-t border-gold-800/20 dark:border-gold-300 bg-white dark:bg-gold-900">
      <div className="container px-4 md:px-6 text-center">
        <div className="inline-flex p-0.5 px-2 rounded-2xl items-center justify-center bg-gold-50 dark:bg-gold-800/50 gap-2 mb-4">
          <Wheat className="h-6 w-6 text-gold-700 dark:text-gold-300" />
          <span className="text-xl font-bold text-gold-700 dark:text-gold-300">АГРОТРЭЙД-ЮГ</span>
        </div>
